...
print("b) To have a 50% chance of getting an A,")
print(paste0("the student would need to study for ", hrs.b," hours."))
```
...
print("Observations: 1. data is weekly S&P500 index from 1990 to 2010, 2. Looks to be an exponential increase in volume over years, 3. Variablily of the lags appears to have a sinusoidal pattern over years, 4. Not noticing a way to predict Up/Down (no visual pattern black/red)")
```
